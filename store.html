...
<head>
	...
	<!-- Langauge felid style -->
	<link href="assets/css/stylesLanguage.css?v2" rel="stylesheet">
					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="awesome-menu ">
							<ul class="project-menu">
								...
								<li>
									<a href="#" data-filter=".development">Restaurant</a>
								</li>
								<li>
									<a href="#" data-filter=".design">Supermarket</a>
								</li>
								<li>
									<a href="#" data-filter=".photo">Other</a>
								</li>
							</ul>
						</div>
					</div>
